...
class Course(models.Model):
    name = models.CharField(verbose_name='Наименование курса/Course name', max_length=256, blank=False, editable=True)
...
class Result(models.Model):
    percent = models.DecimalField(verbose_name='Процент прохождения/Completion percent', decimal_places=1, max_digits=100, editable=True)
    test_result = models.BooleanField(verbose_name='Статус теста/Test status', editable=True, default=False)
